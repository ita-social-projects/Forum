...
import SearchBar from './components/search_field/SearchBar';
import SearchResults from './components/search_field/SearchResults';
...
const App = () => {
  ...
  const handleSearch = (searchTerm) => {
    ...
    axios.get(`http://localhost:8000/api/v1/search/?search_field=${searchTerm}`)      // send data to django
      .then(response => {
