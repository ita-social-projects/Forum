...
export function SignUpPage() {
    return <div className={styles['sign-up']}>
        <div className={styles['sign-up__body']}>
            <DotDecorComponent position={"up-right"} />
            <div className={styles.container}>
                <SignUpFormComponent />
                <div className={styles['sign-in-line']}>
                    <div className={styles['sign-in-line__text']}>Вже були на нашому сайті?</div>
                    <a href='#' className={styles['sign-in-line__link']}>Увійти</a>
                </div>
            </div>
