...
const MainBanner = (props) => {
    return (
        <div className="main-banner-group">
            ...
            <img className="main-banner-group__banner-image1" src={`${process.env.REACT_APP_PUBLIC_URL}/img/banner-img1.jpeg`} alt=""/>
            <img className="main-banner-group__banner-image2" src={`${process.env.REACT_APP_PUBLIC_URL}/img/banner-img2.jpeg`} alt=""/>
            <img className="main-banner-group__banner-image3" src={`${process.env.REACT_APP_PUBLIC_URL}/img/banner-img3.jpeg`} alt=""/>
