      ...
      <div className="about-us-cards-section">
        ...
        <div className="about-us-cards-section__cards">
          {AboutUsText.content.map((card, index) => (
            <div key={index} className={`about-us-cards-section__card ${index === 0 ? 'about-us-cards-section__first-card' : 'about-us-cards-section__next-card'}`}>
              <div className="about-us-cards-section__cards-content">
                <div className="about-us-cards-section__cards-logo">
                  ...
                  <img className="about-us-cards-section__cards-logo__expert" src={`${process.env.REACT_APP_PUBLIC_URL}/svg/${card.logo}`} alt="" />
                </div>
