        ...
        <div className="about-us-cards-section__cards">
          <div className="about-us-cards-section__first-card">
            <div className="about-us-cards-section__cards-content">
              <div className="about-us-cards-section__cards-logo">
                <img className="about-us-cards-section__cards-logo__intersect" src={`${process.env.REACT_APP_PUBLIC_URL}/svg/intersect.svg`} alt=""/>
                <img className="about-us-cards-section__cards-logo__expert" src={`${process.env.REACT_APP_PUBLIC_URL}/svg/expert.svg`} alt=""/>
              </div>
          ...
          <div className="about-us-cards-section__next-card">
            <div className="about-us-cards-section__cards-content">
              <div className="about-us-cards-section__cards-logo">
                <img className="about-us-cards-section__cards-logo__intersect" src={`${process.env.REACT_APP_PUBLIC_URL}/svg/intersect.svg`} alt=""/>
                <img className="about-us-cards-section__cards-logo__expert" src={`${process.env.REACT_APP_PUBLIC_URL}/svg/info.svg`} alt=""/>
              </div>
          ...
          <div className="about-us-cards-section__next-card">
            <div className="about-us-cards-section__cards-content">
              <div className="about-us-cards-section__cards-logo">
                <img className="about-us-cards-section__cards-logo__intersect" src={`${process.env.REACT_APP_PUBLIC_URL}/svg/intersect.svg`} alt=""/>
                <img className="about-us-cards-section__cards-logo__expert" src={`${process.env.REACT_APP_PUBLIC_URL}/svg/contacts.svg`} alt=""/>
              </div>
          ...
          <div className="about-us-cards-section__next-card">
            <div className="about-us-cards-section__cards-content">
              <div className="about-us-cards-section__cards-logo">
                <img className="about-us-cards-section__cards-logo__intersect" src={`${process.env.REACT_APP_PUBLIC_URL}/svg/intersect.svg`} alt=""/>
                <img className="about-us-cards-section__cards-logo__expert" src={`${process.env.REACT_APP_PUBLIC_URL}/svg/exchange.svg`} alt=""/>
              </div>
