            ...
            <div className={classes['data']}>
                <div className={classes['data-block']}>
                    <div className={classes['data-block__field']}>
                        <p className={`${classes['data-block__field--title']} ${classes['edrpou']}`} >ЄДРПОУ</p>
                        <p className={classes['data-block__field--value']}>{profile.edrpou}</p>
                    </div>
                    <div className={classes['data-block__field']}>
                        <p className={classes['data-block__field--title']}>Рік заснування</p>
                        <p className={classes['data-block__field--value']}>{profile.founded}</p>
                    </div>
                    <div className={classes['data-block__field']}>
                        <p className={classes['data-block__field--title']}>Розмір компанії</p>
                        <p className={classes['data-block__field--value']}></p>
                    </div>
                    <div className={classes['data-block__field']}>
                        <p className={classes['data-block__field--title']}>Аудит</p>
                        <p className={classes['data-block__field--value']}></p>
                    </div>
                </div>
                <div className={classes['data-block']}>
                    ...
                    <div className={classes['data-block__field--social-networks']}>
                        <p className={classes['data-block__field--title']}>Соціальні мережі</p>
                        <a href="#">
                    ...
                    <div className={classes['data-block__field']}>
                        <p className={classes['data-block__field--title']}>Співпрацюємо з</p>
                        <p className={classes['data-block__field--cooperate--value']}></p>
                    </div>
                </div>
            </div>
        </div>
