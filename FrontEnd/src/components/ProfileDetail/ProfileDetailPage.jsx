...
function ProfileDetailPage({ isAuthorized }) {
  ...
  const notRequiredData = ['address', 'banner_image', 'logo_image', 'common_info', 'edrpou', 'ipn', 'founded', 'official_name', 'product_info', 'service_info', 'startup_idea', 'logistics', 'cooperation'];
