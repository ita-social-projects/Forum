...
class ProfileListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ('id', 'name', 'person', 'is_registered', 'is_startup', 'official_name', 'region', 'region_display',
...
class ProfileDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ('id', 'official_name', 'region', 'region_display', 'common_info', 'edrpou', 'founded', 'address',
                  'startup_idea', 'name', 'is_registered', 'is_startup', 'categories', 'activities', 'service_info',
                  'product_info', 'banner_image', 'is_saved')
        read_only_fields = ('id', 'official_name', 'region', 'region_display', 'common_info', 'edrpou', 'founded', 'address',
...
class ProfileOwnerDetailViewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'is_registered', 'is_startup', 'categories', 'activities', 'person', 'email',
                  'person_position', 'official_name', 'region', 'region_display', 'common_info', 'phone', 'edrpou',
                  'founded', 'service_info', 'product_info', 'address', 'startup_idea', 'banner_image', 'is_deleted')
        read_only_fields = ('id', 'name', 'is_registered', 'is_startup', 'categories', 'activities', 'person', 'email',
                            'person_position', 'official_name', 'region', 'region_display', 'common_info', 'phone',
                            'edrpou', 'founded', 'service_info', 'product_info', 'address', 'startup_idea',
                            'banner_image', 'is_deleted')
